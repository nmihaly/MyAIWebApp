document.addEventListener('DOMContentLoaded', function() {
  fetch('https://caog5kaijkhhhidqglw5dtbwiy0azcqx.lambda-url.us-east-1.on.aws') //Fetch LAMBDA FUNCTION URL - make sure to not add a trailing slash
  ...
  function generateAiDescription(imageId) {
    const aiDescriptionEndpoint = 'https://kbx2rrnnozh7c7pyiwsmxt4t5a0elsoi.lambda-url.us-east-1.on.aws'; // GENERATE AI LAMBDA FUNCTION URL - and 
